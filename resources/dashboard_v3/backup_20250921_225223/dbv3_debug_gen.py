#!/usr/bin/env python3
"""
Dashboard V3 Debug Generator - Enhanced version with detailed logging
"""
...
class DashboardV3DebugGenerator:
    ...
    def update_default_dates(self, datasets: Dict[str, Any]) -> Dict[str, Any]:
        """Update default dates to 2024 range"""
    ...
    def inject_sql_into_template(self, template: Dict[str, Any], sql_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for dataset_key, dataset_info in datasets.items():
            ...
            print(f"🔍 Added dataset: {dataset_info['name']} - {dataset_info['displayName']}")
            ...
            for widget_layout in page["layout"]:
                ...
                if "filter" in widget["name"]:
                    ...
                    if "start_date" in widget["name"]:
                        ...
                        print(f"🔍 Workspace filter: {len(existing_queries)} existing + {len(param_queries)} parameter queries")
                        ...
                        if "spec" in widget and "encodings" in widget["spec"] and "fields" in widget["spec"]["encodings"]:
                            ...
                            print(f"🔍 Added main query parameterName entry")
                            ...
                            print(f"🔍 Added {len(param_queries)} parameter query entries to encodings")
    ...
    def generate_dashboard(self) -> str:
        ...
        print("🚀 Starting Dashboard V3 Debug Generation...")
        ...
        # Write output file
        output_path = os.path.join(self.base_dir, "dbv3_debug_out.lvdash.json")
        ...
        print("✅ Dashboard V3 debug generation completed successfully!")
...
def main():
    """Main function"""
    generator = DashboardV3DebugGenerator()
