#!/usr/bin/env python3
"""
Simple Test Dashboard Generator - Just 2 widgets to isolate issues
"""
...
class SimpleTestGenerator:
    ...
    def generate_simple_dashboard(self) -> str:
        ...
        print("🚀 Generating Simple Test Dashboard...")
        ...
        # Write output file
        output_path = os.path.join(self.base_dir, "simple_test_out.lvdash.json")
        print(f"💾 Writing simple dashboard to {output_path}...")
        with open(output_path, 'w') as f:
            json.dump(dashboard, f, indent=2)
        
        file_size_kb = os.path.getsize(output_path) / 1024
        print(f"✅ Simple test dashboard generated!")
