...
WHEN MATCHED AND T.row_hash != S.row_hash THEN
    UPDATE SET
        ...
        T.aws_attributes = S.aws_attributes,
        T.azure_attributes = S.azure_attributes,
        T.gcp_attributes = S.gcp_attributes,
...
WHEN NOT MATCHED THEN
    ...
    VALUES (
        ...
        S.init_scripts, S.aws_attributes, S.azure_attributes, S.gcp_attributes,
